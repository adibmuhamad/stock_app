...
import 'package:stock_app/thirdparty/candlestick/models/indicator.dart';
import 'package:stock_app/thirdparty/candlestick/models/main_window_indicator.dart';
import 'package:stock_app/thirdparty/candlestick/widgets/desktop_chart.dart';
import 'package:stock_app/thirdparty/candlestick/widgets/mobile_chart.dart';
import 'package:stock_app/thirdparty/candlestick/widgets/toolbar.dart';
import 'package:stock_app/thirdparty/candlestick/widgets/toolbar_action.dart';
...
class Candlesticks extends StatefulWidget {
  ...
  const Candlesticks({
    ...
    this.style,
  })  : assert(candles.length == 0 || candles.length > 0,
    ...
    return Column(
      children: [
        if ((widget.displayZoomActions == true || widget.actions.isNotEmpty) &&
            (widget.candles.isNotEmpty && mainWindowDataContainer != null)) ...[
          ToolBar(
        ...
        if (widget.candles.isEmpty || mainWindowDataContainer == null)
          Expanded(
            child: widget.loadingWidget ??
                Center(
                  child: CircularProgressIndicator(color: style.loadingColor),
                ),
          )
        else
          Expanded(
